...
import android.com.demo.adapter.CallListAdapter
...
@AndroidEntryPoint
class CallListFragment : BaseFragment<FragmentListBinding, CallListViewModel>() {
    ...
    override fun subscribeUi(viewModel: CallListViewModel) {
